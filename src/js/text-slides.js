const textSlides = (direction) => {
  let currentSlide = document.querySelector('.slides-container__slides--active');
  let nextSlide;
  ...
  if (nextSlide && !nextSlide.classList.contains('main-section__explore')) {
    ...
    currentSlide.classList.remove('slides-container__slides--active');
    nextSlide.classList.add('slides-container__slides--active');
  }
};